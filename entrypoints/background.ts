...
export default defineBackground(() => {
  ...
  const upsertReviewTemplate = createUpsertReviewTemplate(localReviewRepository)
  const deleteReviewTemplate = createDeleteReviewTemplate(localReviewRepository)
