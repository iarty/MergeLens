...
describe('local review messaging protocol', () => {
  ...
  it('rejects unsafe response records and excessive template counts', () => {
    expect(() => parseGetLocalReviewWorkspaceResponse({
      status: 'success',
      correlationId: 'workspace-1',
      data: {
